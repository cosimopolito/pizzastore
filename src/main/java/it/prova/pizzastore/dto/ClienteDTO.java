...
public class ClienteDTO {
    ...
    public ClienteDTO(Long id, String nome, String cognome, String via, String citta, String numeroCivico, String telefono, Boolean attivo) {
        this.id = id;
        this.nome = nome;
    ...
    public static ClienteDTO buildClienteDTOFromModel(Cliente clienteModel) {
        return new ClienteDTO(clienteModel.getId(), clienteModel.getNome(), clienteModel.getCognome(),
                clienteModel.getVia(), clienteModel.getCitta(), clienteModel.getNumeroCivico(), clienteModel.getTelefono(), clienteModel.getAttivo());
    }
    ...
    public static ClienteDTO createClienteDTOFromParams(String idParam, String nomeInputParam, String cognomeInputParam,
        ...
        ClienteDTO result = new ClienteDTO(Long.parseLong(idParam), nomeInputParam, cognomeInputParam, viaParam, cittaParam, numeroCivicoParam, telefonoParam, Boolean.parseBoolean(attivoParam));
        return result;
    }
