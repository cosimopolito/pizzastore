...
public class IngredienteDTO {
    ...
    public static IngredienteDTO buildIngredienteDTOFromModel(Ingrediente ingredienteModel) {
        return new IngredienteDTO(ingredienteModel.getId(), ingredienteModel.getDescrizione(), ingredienteModel.getPrezzo(),
                ingredienteModel.getCodice());
    }

    public static IngredienteDTO createIngredienteDTOFromParams(String idParam, String descrizioneParam, String prezzoParam,
                                                        String codiceParam) {
