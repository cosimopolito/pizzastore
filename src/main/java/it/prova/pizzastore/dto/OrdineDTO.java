...
public class OrdineDTO {
    ...
    public static OrdineDTO buildClienteDTOFromModel(Ordine ordineModel) {
        return new OrdineDTO(ordineModel.getId(), ordineModel.getDataOrdine(), ordineModel.getCodice());
    }

    public static OrdineDTO createOrdineDTOFromParams(String idParam, String dataParam, String codiceParam, String closedParam) {
