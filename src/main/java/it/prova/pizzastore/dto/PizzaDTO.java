...
public class PizzaDTO {
    ...
    public static PizzaDTO buildPizzaDTOFromModel(Pizza pizzaModel) {
        return new PizzaDTO(pizzaModel.getId(), pizzaModel.getDescrizione(), pizzaModel.getCodice(), pizzaModel.getPrezzoBase());
    }

    public static PizzaDTO createPizzaDTOFromParams(String idParam, String descrizioneParam, String codiceParam, String prezzoBase) {

        PizzaDTO result = new PizzaDTO(Long.parseLong(idParam), descrizioneParam, codiceParam, Double.parseDouble(prezzoBase));
        return result;
    }
