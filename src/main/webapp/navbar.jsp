        ...
        <ul class="navbar-nav mr-auto">
            ...
            <c:if test="${userInfo.isPizzaiolo() }">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Gestione Pizzaiolo</a>
                    <div class="dropdown-menu" aria-labelledby="dropdown01">
                        <a class="dropdown-item" href="${pageContext.request.contextPath}/pizzaiolo/PrepareSearchPizzaioloServlet">Ricerca Utenti</a>
                        <a class="dropdown-item" href="${pageContext.request.contextPath}/pizzaiolo/PrepareInsertPizzaioloServlet">Inserisci Utente</a>
                    </div>
                </li>
            </c:if>
